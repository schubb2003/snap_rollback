...
def parse_inputs():
    ...
    parser.add_argument('-dm', type=str,
                        required=True,
                        metavar='mvip',
                        help='MDestination MVIP name or IP')
    parser.add_argument('-du', type=str,
                        required=True,
                        metavar='username',
                        help='Destination username to connect with')
    parser.add_argument('-dp', type=str,
                        required=True,
                        metavar='password',
                        help='Destination password for user')
...
def main():
    ...
    source_mvip = argv.sm
    source_user = argv.su
    source_password = argv.sp
    dest_mvip = argv.dm
    dest_user = argv.du
    dest_password = argv.dp
    ret_time = argv.rt
    source_vol_array = argv.va
